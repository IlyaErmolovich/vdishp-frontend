...
const GamePage = () => {
  ...
  return (
    <PageContainer>
      <GameHeader>
        <BackgroundImage image={getImageUrl(game.cover_image, '/placeholder-game.jpg', game.id, 'game')} />
        <GameContent>
          <GameCover>
            <img 
              src={getImageUrl(game.cover_image, '/placeholder-game.jpg', game.id, 'game')} 
              alt={game.title} 
            />
          </GameCover>
          <GameInfo>
